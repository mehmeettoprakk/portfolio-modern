...
export const Footer = () => {
  const shortcuts = [
    { href: "https://github.com/mehmeetoprakk", label: "GitHub" },
    { href: "https://www.linkedin.com/in/mehmeetoprakk", label: "LinkedIn" },
    { href: "https://www.instagram.com/mehmeetoprakk", label: "İnstagram" },
  ];
  ...
  const onHandleCopy = (contact: IContact) => {
    ...
    toast.success(`${contact.label} copied to clipboard!`, {
